      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="space-y-6">
              {problems.map((problem, index) => (
                <div key={index} className="flex gap-4 bg-white/60 p-4 rounded-lg border border-blue-100 shadow-sm">
            ...
            <div className="mt-8 flex gap-4 items-center bg-gradient-to-r from-green-50 to-blue-50 p-4 rounded-lg border border-green-100">
              ...
              <div>
                <h3 className="font-medium text-gray-900">Nuestra metodología de tasación</h3>
                <p className="mt-1 text-sm text-gray-600">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 relative">
            {/* Sello de urgencia */}
            <div className="absolute -top-3 -right-3 bg-red-600 text-white text-xs font-bold px-3 py-1 rounded-full animate-pulse flex items-center gap-1">
              <Clock size={14} />
              VENTANA LIMITADA
            </div>
            ...
            {!submitted ? (
              <>
                ...
                <ul className="text-gray-600 mb-6 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1 rounded-full bg-green-100 p-1">
                      <CheckCircle2 size={12} className="text-green-600" />
                    </div>
                    <span><strong>Valoración preliminar</strong> basada en datos de mercado</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1 rounded-full bg-green-100 p-1">
                      <CheckCircle2 size={12} className="text-green-600" />
                    </div>
                    <span>Opinión sobre <strong>autenticidad y atribución</strong></span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1 rounded-full bg-green-100 p-1">
                      <CheckCircle2 size={12} className="text-green-600" />
                    </div>
                    <span>Respuesta en <strong>24-48 horas</strong> por tasadores certificados</span>
                  </li>
                </ul>
                
                <div className="bg-blue-50 p-3 rounded-lg mb-6 border-l-4 border-primary">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    <label htmlFor="artwork-photo" className="block text-sm font-medium text-gray-700 mb-1">
                    ...
                    <input
                      ...
                      id="artwork-photo"
                      accept="image/*"
                      className="w-full p-2 text-sm text-gray-600 bg-gray-50 rounded-lg border border-gray-300"
                    />
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-primary to-blue-600 px-6 py-3 text-white font-medium hover:from-primary/90 hover:to-blue-600/90 transition-all duration-200 disabled:opacity-70"
                  >
                    {loading ? (
                      <>Procesando...</>
                    ) : (
              ...
              <div className="text-center py-8">
                ...
                <button
                  ...
                  className="mt-6 text-primary font-medium hover:underline flex items-center gap-1 mx-auto"
                >
